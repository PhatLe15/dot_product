...
HD_PWD='C:/Users/phatle/BitCountDotProduct/BitCountDotProduct.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log dot_product_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source dot_product_top.tcl -notrace
