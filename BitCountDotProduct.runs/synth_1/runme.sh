...
HD_PWD='C:/Users/phatle/BitCountDotProduct/BitCountDotProduct.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log dot_product_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source dot_product_top.tcl
